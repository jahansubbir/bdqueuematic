...
Add Token Type
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="post" action="{{ route('tokenTypes.store') }}">
                    @csrf   
             <!-- Name -->
        <div>
        ...
        <div>
            ...
            <x-text-input id="process_duration" class="block mt-1 w-full" type="text" name="process_duration" :value="old('process_duration')" required autofocus autocomplete="process_duration" />
        ...
        <div>
          ...
          <input type="checkbox" id="is_bulk_processable" name="is_bulk_processable" 
