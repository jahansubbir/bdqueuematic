                    ...
                    <form method="post" action="{{ route('counters.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="opening_hour" class="block mt-1 w-full" type="text" name="opening_hour"
                                :value="old('opening_hour')" required autocomplete="opening_hour" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="lunch_start" class="block mt-1 w-full" type="text" name="lunch_start"
                                :value="old('lunch_start')" required autocomplete="username" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="lunch_end" class="block mt-1 w-full" type="text" name="lunch_end"
                                :value="old('lunch_end')" required autocomplete="username" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="closing_hour" class="block mt-1 w-full" type="text" name="closing_hour"
                                :value="old('closing_hour')" required autocomplete="closing_hour" />
