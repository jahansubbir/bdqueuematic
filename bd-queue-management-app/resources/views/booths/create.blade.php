...
<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="post" action="{{ route('booths.store') }}">
                    @csrf   
             <!-- Name -->
        <div>
    ...
    @endforeach
        ...
        <div>
            ...
            <x-text-input id="booth_no" class="block mt-1 w-full" type="text" name="booth_no" :value="old('booth_no')" required autofocus autocomplete="booth_no" />
